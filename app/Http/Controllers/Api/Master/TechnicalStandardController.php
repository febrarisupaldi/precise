...
class TechnicalStandardController extends Controller
{
    ...
    public function index($kind): JsonResponse
    {
        ...
        return response()->json(["status" => "ok", "data" => $this->technical], 200);
    }
            ...
            try {
                ...
                foreach ($data['detail'] as $detail) {
                    ...
                    if ($validator->fails()) {
                        ...
                        $values[] = [
                            'technical_std_hd_id'       => $data['technical_std_hd_id'],
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                DB::table('precise.technical_std_hd', $data['technical_std_hd_id'])
                    ->where('', $data[''])
                    ->update([
                        'item_id'                   =>  $data['item_id'],
                        'default_tonnage'           =>  $data['default_tonnage'],
    ...
    public function check(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return response()->json(['status' => 'ok', 'message' => $this->technical], 200);
        }
    }
}
